...
export const apiSearchTourByAddress = (address) =>
  axios.get(`${URL_BASIC}/search/${address}`)
...
export const apiGet10TourByPriceDesc = () =>
  axios.get(`${URL_BASIC}/price-desc`)
// api get tour by page number
export const apiGet4TourByNumPage = (id) => axios.get(`${URL_BASIC}/page/${id}`)
